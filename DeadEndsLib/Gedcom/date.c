...
static CString extractString = null;
static CString extractCursor = null;
...
String formatDate (CString string, int dayFmt, int monthFmt, int yearFmt, int dateFmt, bool cmplx) {
...
void extractDate(CString string, int *pmod, int *pday, int *pmonth, int *pyear, String *pyrstr) {
    int tok, ival, era = 0;
    String sval;
