...
bool removeFromSortedBlock(Block*, CString, CString(*g)(const void *a), int(*c)(CString, CString), void(*d)(void*));
bool removeFromUnsortedBlock(Block*, CString, CString(*g)(const void *a), void(*d)(void*));
...
void uniqueBlock(Block*, CString(*g)(const void*), void(*d)(void*));
