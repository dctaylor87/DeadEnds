...
proc main ()
{
    ...
    getint(do_notes,"Enter 0 for no notes, 1 for notes")
    getint(do_keys,"Enter 0 for no keys, 1 for keys")
    getint(malesonly,
      "Enter 0 for all descendants, 1 for male lines only")
    getint(generations,"Enter number of generations (0=all)")
