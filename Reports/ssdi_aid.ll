...
proc main() {
  ...
  getint(minage,"Enter minimum age for listing:")

  getint(html,"Enter 0 for text, 1 for html output:")

  if (html) {
    getint(includebyears,"Enter 1 to include birth years in database query")
    "<HTML>\n"
    "<HEAD>\n"
