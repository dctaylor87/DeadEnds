...
*/
  ...
  if(TRUE) {
    set(root_person, 0)
    getindi(root_person, "Identify root person for chart (blank to cancel)")
    if(not(root_person)) {
...
*/
  ...
  if(multi_page) {
    ...
    if(TRUE) {
      getint( x_pages, "Number of horizontal pages on finished chart")
      getint( y_pages, "Number of vertical pages on finished chart")
    } else {
      set(x_pages, 1)
      set(y_pages, 2)
    }
...
*/
  ...
  if(FALSE) {
    if(display_label) {
      getstr(chart_label, "Label for corner of chart (your name, date)")
...
*/
  ...
  if(FALSE) {
    getint( color_chart, "Enter 0 for black/white, 1 for color")
  } else {
    set(color_chart, 1)
  }
...
*/
  ...
  if(FALSE) {
    getint(bold_chart, "Enter 1 for bold direct line, 0 for all the same")
  } else {
    set(bold_chart, 1)
  }
...
*/
  ...
  if(FALSE) {
    getint(title_method, "Title method (0:none,1:prefix,2:suffix,3:guess)")
  } else {
    set(title_method, 3)
  }
...
*/
  ...
  if(FALSE) {
    getint(name_letters, "Maximum name length")
  } else {
    set(name_letters, 40)
  }
...
*/
  ...
  if(TRUE) {
    ...
    if( eq(mc, 1)) {
       ...
       getint(paper_width, "Enter image width, in points")
       getint(paper_height, "Enter image height, in points")
       set(paper_name, "EPSF")
       set( multi_page, 0)
       set( x_pages, 1)
       set( y_pages, 1)
...
*/
    ...
    if(FALSE) {
      getint(margin_top, "Minimum width of TOP margin")
      getint(margin_bottom, "Minimum width of BOTTOM margin")
      getint(margin_left, "Minimum width of LEFT margin")
      getint(margin_right, "Minimum width of RIGHT margin")
    } else {
      set(margin_top, 30)
