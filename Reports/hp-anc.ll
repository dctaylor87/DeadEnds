...
*/
  ...
  if (1)  {
    ...
    while ( not (root_person) )  {
      getindi (root_person, "Identify root person for chart")
    }
  }  else  {
...
*/
  ...
  if (eq (chart_type, 0))  {
    ...
    if (1)  {
      getint (depth_siblings, "How many generations to show siblings")
    }  else  {
...
*/
  ...
  if (0)  {
    getint (multi_page, "Enter 0 for single page, 1 for multipage")
  }  else  {
    set (multi_page, 0)
  }
...
*/
  ...
  if (multi_page)  {
    ...
    if (1)  {
      getint (x_pages, "Number of horizontal pages")
      getint (y_pages, "Number of vertical pages")
    }  else  {
      set (x_pages, 3)
      set (y_pages, 3)
    }
