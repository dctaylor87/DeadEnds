...
proc main() {
  ...
  getint(log,"logging people (0=no, 1=yes) ")
  getint(who,
  ...
  while (1) {
    getstr(restriction_equation,"restricted by ")
  ...
  set(sort_it,0)
  if (eq(deltabin,0)) {
    getint(sort_it,"Sort the output? (0=no, 1=yes)")
  }
