typedef void (*CALLBACK_FNC)(Word);
...
extern void register_uilang_callback (CALLBACK_FNC fncptr, Word uparm);
extern void unregister_uilang_callback (CALLBACK_FNC fncptr, Word uparm);
extern void register_uicodeset_callback (CALLBACK_FNC fncptr, Word uparm);
extern void unregister_uicodeset_callback (CALLBACK_FNC fncptr, Word uparm);
