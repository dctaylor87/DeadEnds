...
// searchPath -- Search path to use in finding the file.
{
    ...
    // If there is no path variable return the name as the only possibility.
    ...
    // If the lengths of the file name and the path are too long return null; should not happen.
...
// lastpathname -- Return the last componenet of a path.
//--------------------------------------------------------------------------------------------------
//static String lastpathname (String path)
